class MainRouter(object):
    ...
    def db_for_read(self, model, **hints):
        if model._meta.app_label == 'config':
            ...
            return 'default'
        elif model._meta.app_label == 'models_base' or model._meta.app_label == 'cuentas_por_pagar' or\
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if (obj1._meta.app_label  == 'auth' and obj2._meta.app_label == 'django') or (obj1._meta.app_label  == 'django' and obj2._meta.app_label == 'auth'):
           return True           
        elif (obj1._meta.app_label == 'models_base' or obj1._meta.app_label == 'cuentas_por_pagar' or\
            ...
            (obj2._meta.app_label == 'models_base' or obj2._meta.app_label == 'cuentas_por_pagar' or\
    ...
    def allow_syncdb(self, db, model):
        ...
        if model._meta.app_label == 'config' or 'CONFIG' in db:
            ...
            ( model._meta.app_label == 'models_base' or model._meta.app_label == 'cuentas_por_pagar' or  model._meta.app_label == 'ventas' or model._meta.app_label == 'cuentas_por_cobrar' or model._meta.app_label == 'punto_de_venta' or model._meta.app_label == 'contabilidad'):
            return False
        else:
            return True
